                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <form action="" method="POST">
                        <div class="form-row">
                          ...
                          <div class="form-row">
                              <div class="col-lg-7">
                                  <button type="sumbit" name="login_btn" id="login_btn" class="btn1 mt-3 mb-5">SIGN IN</button>
                              </div>
                          </div>
        
                          <p>Already have an account <a href="http://127.0.0.1:8000/register">Log in</a></p>
                      </form>
                </div>
            </div>
        </div>
